...
interface FormData {
  ...
  service: string;
  companyType: string;
  companyName: string; // Added companyName to match form input
}

// Define Redux state type (adjust based on your actual Redux store structure)
interface RootState {
...
// Define service and company type options
// interface Option {
//   value: string;
//   label: string;
// }
...
// Define form animation variants
const formVariants = {
