...
const ExpandedBlog = () => {
      ...
      list: [
        {
          ...
          description: "These trends are revolutionizing how businesses connect with their audiences and drive meaningful engagement across all digital platforms."
        },
        {
          ...
          description: "Successful implementation requires a strategic approach that aligns with your business objectives and target audience needs while maintaining consistent brand messaging."
        }
      ],
    },
    {
  ...
  const [selectedBlogData, setSelectedBlogData] = useState<any>({});
        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          <div className="text-center space-y-6 max-w-md px-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              The blog post you're looking for doesn't exist or has been moved. Please check the URL or browse our other articles.
            </p>
            <Link
              to="/blogs"
  ...
  return (
    <Mainlayout>
      ...
      <section
        className="flex justify-center items-center h-[70vh] md:justify-end md:items-center md:h-screen bg-center bg-cover px-7 md:px-14 relative"
        style={{
      ...
      <section className="px-4 sm:px-7 md:px-14 py-6 md:py-12 bg-gradient-to-b from-[#f7f7f7] to-white min-h-screen">
            ...
            <div className="bg-white rounded-xl md:rounded-2xl shadow-lg p-4 md:p-6 lg:p-8">
              ...
              <div className="space-y-6 md:space-y-8">
                {selectedBlogData?.list?.map((listItem, index) => (
                  <div key={index} className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl md:rounded-2xl p-4 md:p-6 lg:p-8 border-l-4 border-[#3CA2E2]">
                    {listItem?.title && (
                    ...
                    {listItem?.lists && listItem.lists.length > 0 && (
                      <ul className="space-y-3 md:space-y-4 mb-4 md:mb-6 ml-4 md:ml-6">
                        {listItem.lists.map((point, pointIndex) => (
                          <li key={pointIndex} className="flex items-start gap-3 md:gap-4 text-gray-700">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <div className="bg-white rounded-xl md:rounded-2xl shadow-lg overflow-hidden">
                <div className="bg-gradient-to-r from-[#3CA2E2] to-[#052EAA] p-4 md:p-6">
                  <h2 className="text-lg md:text-xl font-bold text-white">Latest Blogs</h2>
                </div>
              ...
              <div className="bg-gradient-to-br from-[#3CA2E2] via-[#2691d9] to-[#052EAA] rounded-xl md:rounded-2xl p-4 md:p-6 text-white shadow-lg">
                <div className="text-center space-y-3 md:space-y-4">
                  ...
                  <h3 className="text-base md:text-lg font-bold">Ready to Get Started?</h3>
                  <p className="text-xs md:text-sm text-blue-100 leading-relaxed">
                    Schedule a consultation with our experts today and transform your business.
                  </p>
